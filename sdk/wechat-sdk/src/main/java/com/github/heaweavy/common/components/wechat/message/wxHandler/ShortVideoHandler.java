...
import com.github.heaweavy.common.components.wechat.message.framework.router.Rules;
 ...
 * @modefier
 */
@Rules(MessageType.SHORTVIDEO)
public class ShortVideoHandler extends AbstractWxHandler{
}
